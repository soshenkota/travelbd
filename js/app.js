(() => {
    ...
    function initSliders() {
        if (document.querySelector(".footer-main__slider")) new swiper_core_Swiper(".footer-main__slider", {
            modules: [Navigation],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".destination__slider")) new swiper_core_Swiper(".destination__slider", {
            ...
            navigation: {
                prevEl: ".destination-slide__button.destination-slide__button--left",
                nextEl: ".destination-slide__button.destination-slide__button--right"
            },
            on: {}
        });
...
***************************************************************************** */
    ...
    const objectClicks = document.querySelectorAll(".footer-main-slide__play");
    const opacityOrangs = document.querySelectorAll(".footer-main-slide__opacity");
    const hiddenWhrites = document.querySelectorAll(".footer-main-slide__hidden");
    objectClicks.forEach((objectClick => {
        objectClick.addEventListener("click", (e => {
            objectClicks.forEach((el => {
                el.classList.remove("new");
            }));
            objectClick.classList.add("new");
            reversColor();
        }));
    }));
    function reversColor() {
        opacityOrangs.forEach((opacityOrang => {
            if (opacityOrang.closest(".new")) opacityOrang.style.display = "block"; else opacityOrang.style.display = "none";
        }));
        hiddenWhrites.forEach((hiddenWhrite => {
            if (hiddenWhrite.closest(".new")) hiddenWhrite.style.display = "none"; else hiddenWhrite.style.display = "block";
        }));
    }
    window["FLS"] = false;
    isWebp();
